...
namespace Project.API.Controllers
{
    ...
    public class UserController : Controller
    {
        ...
        {
            int pageIndex = Convert.ToInt32(HttpContext.Request.Headers[_configSettings.RequestSettings.PageIndex]);
            int pageSize = Convert.ToInt32(HttpContext.Request.Headers[_configSettings.RequestSettings.PageSize]);
        ...
        public async Task<IActionResult> Add([FromBody] UserToAddDTO userToAddDTO)
        {
            ...
            {
                return Ok(new ErrorDataResult<Result>(Messages.InvalidModel));
            }
