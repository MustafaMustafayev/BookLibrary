...
namespace Project.Core.Concrete
{
    public class UtilService : IUtilService
    {
        ...
        {
            return new StringContent(JsonConvert.SerializeObject(obj), UnicodeEncoding.UTF8, GetContentType());
        }
        ...
        public int? GetUserIdFromToken(string tokenString)
        {
            ...
            int userId = Convert.ToInt32(token.Claims.First(c => c.Type == _configSettings.AuthSettings.TokeNameIdKey).Value);
            return userId;
        }
